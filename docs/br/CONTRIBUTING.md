...
A linha do seu pixel deve ser classificada primeiro pela coordenada y e depois pela x. Se você não tiver certeza sobre suas alterações, faça a alteração e execute `npm run format:sort-pixels` e ele deverá classificar seu pixel na posição apropriada.
